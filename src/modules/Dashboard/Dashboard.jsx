...
>>>>>>> 2a2e783dda8661c84485430fb95f5b51b371013f
                      ...
                      >
                        <div className="d-flex align-items-center">
                          <img
                            ...
                            height={40}
                            src={
                              user?.avatar?.length > 50 ? user?.avatar : profile
                            }
                            alt=""
                          />
                          <p className="fw-bold fs-5 ms-3">{user?.name}</p>
                        ...
                        <p
                          ...
                          className={`fs-6 px-2  rounded-pill   ${
