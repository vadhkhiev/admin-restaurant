    ...
    <div className='m-3'>
        <div className='py-3 rounded-3 custom-border'>
          <div className='p-2 px-3 d-flex justify-content-between'>
            <div>
              <span className='p-2 custom-border rounded-3'>
                <span style={{ textDecoration: 'none' }} className='p-2 text-white borderbottom'>
                  Access <GrUserAdmin className='pb-1' />
                </span>
              </span>
            </div>
            <div>
              <button onClick={handleBack} className='btn custom-border custom-btn text-white rounded'>
                {'< Back'}
              </button>
            </div>
          </div>
          <h4 className='text-white d-flex align-items-center ms-3 mb-3'>
            Permission of{' '}
            <span className='text-primary ms-2'>{role.name}</span>
          </h4>
          <main className='rounded-3 custom-border mx-3'>
            <table className='table table-borderless'>
              <thead>
                <tr className='py-3'>
                  <th className='border-bottom border-dark text-white-50'>
                    # Permission
                  </th>
                  <th className='border-bottom border-dark text-white-50 d-flex justify-content-end'>
                    check
                  </th>
                </tr>
              </thead>
                  ...
                  {loading ? (
                    ...
                    rolePermissions?.map((permission, index) => (
                      <tr key={index} className="hover-effect">
                        <td className="border-bottom border-dark custom-text text-white-50 fs-5">
          ...
          <div className='d-flex justify-content-end me-3 mt-3'>
            <button onClick={handleReset} className='btn btn-danger me-3'>
              Reset
            </button>
            <button onClick={handleSubmit} className='btn custom-border text-white custom-btn'>
              Save
            </button>
          </div>
        </div>
